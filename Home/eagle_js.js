...
//            side_menu_elements[i].style.backgroundColor = '#0A0801';//Black
//            side_menu_elements[i].style.backgroundColor = 'Red';
            side_menu_elements[i].style.border = '2px solid red';
        } else
//            side_menu_elements[i].style.backgroundColor = 'black';
            side_menu_elements[i].style.border = 'none';
